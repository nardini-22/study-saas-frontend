...
>(({ className, shortcut, hint, children, ...props }, forwardedRef) => (
  <DropdownMenuPrimitives.Item
    ...
    className={cn(
      // base
      "group/DropdownMenuItem relative flex cursor-pointer select-none items-center gap-x-2 rounded-sm py-1.5 pl-2 pr-1 outline-hidden transition-colors data-[state=checked]:font-semibold sm:text-sm",
      // text color
      "text-text-primary dark:text-gray-50",
      // disabled
      "data-disabled:pointer-events-none data-disabled:text-gray-400 data-disabled:hover:bg-none dark:data-disabled:text-gray-600",
      // focus
      "focus-visible:bg-gray-100 dark:focus-visible:bg-text-primary",
      // hover
      "hover:bg-gray-200 dark:hover:bg-text-primary",
      className
    )}
